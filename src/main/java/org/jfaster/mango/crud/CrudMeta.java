...
public class CrudMeta {
  ...
  // 使用 @AutoGeneratedValue 修饰的类属性
  private final String property4AutoGeneratedValue;

  // 使用 @AutoGeneratedValue 修饰的类属性对应的数据库列
  ...
  public CrudMeta(Class<?> clazz) {
    ...
    String prop4Id = null;
    String col4Id = null;
    String prop4AutoGeneratedValue = null;
    String col4AutoGeneratedValue = null;
    for (PropertyMeta propertyMeta : BeanUtil.fetchPropertyMetas(clazz)) {
      ...
      AutoGeneratedValue autoGeneratedValueAnno = propertyMeta.getPropertyAnno(AutoGeneratedValue.class);
      if (autoGeneratedValueAnno != null) {
        if (prop4AutoGeneratedValue != null || col4AutoGeneratedValue != null) {
          throw new IllegalStateException("duplicate @AutoGeneratedValue annotation");
        }
        prop4AutoGeneratedValue = prop;
        col4AutoGeneratedValue = col;
      }
    }
    ...
    property4Id = prop4Id;
    column4Id = col4Id;
    property4AutoGeneratedValue = prop4AutoGeneratedValue;
    column4AutoGeneratedValue = col4AutoGeneratedValue;
  }
  ...
  public String getProperty4AutoGeneratedValue() {
    return property4AutoGeneratedValue;
  }

  public String getColumn4AutoGeneratedValue() {
    return column4AutoGeneratedValue;
  }

  public boolean isAutoGenerated() {
    return property4AutoGeneratedValue != null;
  }
