 ...
 * @author ash
 */
public class BuildinBatchAddBuilderFactory extends AbstractBuildinBuilderFactory {
  ...
  AbstractBuildinBuilder createInternalBuilder(CrudMeta cm) {
    return new BuildinAddBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns(), cm.isAutoGenerateId());
  }
