 ...
 * @author ash
 */
public class BuildinBatchUpdateBuilderFactory extends AbstractBuildinBuilderFactory {
  ...
  AbstractBuildinBuilder createInternalBuilder(CrudMeta cm) {
    return new BuildinUpdateBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns());
  }
