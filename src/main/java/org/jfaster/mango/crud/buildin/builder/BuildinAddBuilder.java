...
public class BuildinAddBuilder extends AbstractBuildinBuilder {
  ...
  public BuildinAddBuilder(String prop4AutoGeneratedValue, List<String> props, List<String> cols) {
    properties = new ArrayList<>(props);
    columns = new ArrayList<>(cols);
    if (prop4AutoGeneratedValue != null) {
      int index = props.indexOf(prop4AutoGeneratedValue);
      if (index < 0) {
        throw new IllegalArgumentException("error prop4AutoGeneratedValue id [" + prop4AutoGeneratedValue + "]");
      }
