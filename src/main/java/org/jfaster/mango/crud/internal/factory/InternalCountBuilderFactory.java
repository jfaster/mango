...
import org.jfaster.mango.crud.internal.builder.InternalCountBuilder;
 ...
 * @author ash
 */
public class InternalCountBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalCountBuilder();
  }
