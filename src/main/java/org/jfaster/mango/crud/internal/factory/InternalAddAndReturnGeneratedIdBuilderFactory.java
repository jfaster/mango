...
import org.jfaster.mango.crud.internal.builder.InternalAddBuilder;
 ...
 * @author ash
 */
public class InternalAddAndReturnGeneratedIdBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalAddBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns(), true);
  }
