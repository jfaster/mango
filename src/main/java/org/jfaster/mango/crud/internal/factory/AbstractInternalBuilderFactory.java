 ...
 * @author ash
 */
public abstract class AbstractInternalBuilderFactory extends BuilderFactory {
  ...
  public Builder doTryGetBuilder(String name, Type returnType, List<Type> parameterTypes, Class<?> entityClass, Class<?> idClass) {
    return (nameMatched(name) &&
        ...
        createInternalBuilder(new CrudMeta(entityClass)) :
        null;
  }
  ...
  abstract AbstractInternalBuilder createInternalBuilder(CrudMeta cm);
