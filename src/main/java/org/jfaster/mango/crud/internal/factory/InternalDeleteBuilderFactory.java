...
import org.jfaster.mango.crud.internal.builder.InternalDeleteBuilder;
 ...
 * @author ash
 */
public class InternalDeleteBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalDeleteBuilder(cm.getColumnId());
  }
