...
import org.jfaster.mango.crud.internal.builder.InternalUpdateBuilder;
 ...
 * @author ash
 */
public class InternalBatchUpdateBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalUpdateBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns());
  }
