 ...
 * @author ash
 */
public class InternalBatchAddBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalAddBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns(), cm.isAutoGenerateId());
  }
