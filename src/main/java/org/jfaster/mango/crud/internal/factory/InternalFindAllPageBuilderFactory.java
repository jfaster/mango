...
import org.jfaster.mango.crud.internal.builder.InternalGetAllBuilder;
 ...
 * @author ash
 */
public class InternalFindAllPageBuilderFactory extends AbstractInternalBuilderFactory {
  ...
  AbstractInternalBuilder createInternalBuilder(CrudMeta cm) {
    return new InternalGetAllBuilder(cm.getColumns());
  }
