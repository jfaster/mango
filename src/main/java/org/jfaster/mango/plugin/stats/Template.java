...
public class Template {
  ...
  public static String render(Map<String, OperatorStat> osMap, Map<String, ExtendStats> esMap, boolean isFetchAll, String key) {
    ...
    for (String sKey : osMap.keySet()) {
      ...
      if (isFetchAll || os.getDatabaseExecuteCount() > 0 || os.getHitCount() > 0) {
        ...
        buildTD(sb, div(os.getAverageDatabaseExecutePenalty(), 1000000));
        ...
        buildTD(sb, div(os.getAverageCacheBatchDeletePenalty(), 1000000));
    ...
    String line = "var action = window.location.pathname + '?type=reset";
    if (key != null) {
      line = line + "&key=" + key;
    }
    line = line + "';";
  ...
  private final static String[] c3s = new String[] {
