...
public class NodeCollectVisitor implements ParserVisitor {
    ...
    public static class NodeInfo {
        List<ASTJDBCParameter> jdbcParameters = new LinkedList<ASTJDBCParameter>();
        List<ASTJDBCIterableParameter> jdbcIterableParameters = new LinkedList<ASTJDBCIterableParameter>();
        List<ASTGlobalTable> globalTables = new LinkedList<ASTGlobalTable>();
    }
