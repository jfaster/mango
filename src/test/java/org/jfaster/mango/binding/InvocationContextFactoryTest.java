...
public class InvocationContextFactoryTest {
  ...
  public void testNewInvocationContext() throws Exception {
    ...
    BindingParameterInvoker nameInvoker =
        TransferableBindingParameterInvoker.create(String.class, BindingParameter.create("name", "", null));
    BindingParameterInvoker idInvoker =
        TransferableBindingParameterInvoker.create(String.class, BindingParameter.create("id", "", null));
