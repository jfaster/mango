...
public class FunctionalSetterInvokerTest {
    ...
    public static class StringToIntegerFunction extends SimpleSetterFunction<String, Integer> {
    ...
    public static class IntegerToStringFunction extends SimpleSetterFunction<Integer, String> {
    ...
    public static class StringToIntegerListFunction extends SimpleSetterFunction<String, List<Integer>> {
    ...
    public static class StringIntArrayFunction extends SimpleSetterFunction<String, int[]> {
    ...
    public void testException3() throws Exception {
        thrown.expect(IncorrectSetterAnnotationException.class);
        thrown.expectMessage("@Setter annotation can not be placed on the get method [java.lang.String org.jfaster.mango.invoker.FunctionalSetterInvokerTest$H.getX()]");
        Method method = H.class.getDeclaredMethod("getX");
