...
public class ParameterContextTest {
    ...
    public void testSelectAndUpdate() throws Exception {
        ...
        assertThat(ctx.getPropertyType("1", ""), equalTo(t0.getType()));
        assertThat(ctx.getPropertyType("2", ""), equalTo(t1.getType()));
    ...
    public void testBatchUpdate() throws Exception {
        ...
        assertThat(ctx.getPropertyType("1", "name"), equalTo((new TypeToken<String>() {}).getType())); // test cache
