...
//    }
//
//    static class OrderDataSourceRouter implements DatabaseShardingStrategy<Integer> {
//
//        @Override
//        public String getDatabase(Integer cid, int type) {
//            return getDataSourceNameByCid(cid);
//        }
//
//    }
//
//    static class OrderTablePartition implements TableShardingStrategy<String> {
//
//        @Override
//        public String getTargetTable(String table, String uid, int type) {
