 ...
 * @author ash
 */
public class BuildinAddAndReturnGeneratedIdBuilderFactoryTest {

  @Test
  public void test() throws Exception {
    BuildinAddAndReturnGeneratedIdBuilderFactory factory = new BuildinAddAndReturnGeneratedIdBuilderFactory();
