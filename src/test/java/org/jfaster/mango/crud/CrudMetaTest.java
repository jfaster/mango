...
public class CrudMetaTest {
  ...
  public void test() throws Exception {
    ...
    assertThat(cm.getProperty4AutoGeneratedValue(), equalTo("id"));
    assertThat(cm.getColumn4AutoGeneratedValue(), equalTo("id"));
  ...
  public void test2() throws Exception {
    ...
    assertThat(cm.getProperty4AutoGeneratedValue(), nullValue());
    assertThat(cm.getColumn4AutoGeneratedValue(), nullValue());
